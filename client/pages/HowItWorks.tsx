                ...
                <div className="space-y-4">
                  <div className="bg-white rounded-xl p-4 shadow-sm">
                    <div className="flex items-center justify-between">
                      <span className="font-semibold text-black">Charmin Ultra Soft</span>
                  ...
                  <div className="bg-white rounded-xl p-4 shadow-sm">
                    <div className="flex items-center justify-between">
                      <span className="font-semibold text-black">Cottonelle Clean Care</span>
                      <span className="font-bold text-black">$8.99</span>
                    </div>
                    <span className="text-sm text-gray-500">8 regular rolls</span>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div className="bg-white rounded-xl p-6 shadow-sm">
                  ...
                  <div className="space-y-3 text-sm">
                    <div className="flex justify-between">
                      <span className="text-gray-600">Charmin Ultra Soft x2</span>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="bg-gray-50 rounded-2xl p-8">
                ...
                <div className="bg-white rounded-xl p-6 shadow-sm text-center">
                  <h4 className="font-semibold text-black mb-4">Order tracking</h4>
                  <div className="space-y-3 text-sm">
                    <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center justify-between">
                      <span className="font-medium text-black">Out for delivery</span>
